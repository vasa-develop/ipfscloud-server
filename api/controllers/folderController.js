...
const ipfs_infura = ipfsAPI({'api-path': '/api/v0/', host: nodes.ipfs_california, port: '5001', protocol: 'https'});
const ipfsecret = new IPFSecret({ host: nodes.ipfs_california,  port: 5001, proto: 'https' });
